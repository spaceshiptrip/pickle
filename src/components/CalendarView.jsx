...
function CenterTitleSpinnerPortal({ show }) {
  ...
  const findTitleEl = () => document.querySelector(".fc .fc-toolbar-title");
            ...
            return (
              <div className="fc-event-content-wrap">
                {isCancelled ? (
                  ...
                  <span
                    className="fc-dot fc-dot-scheduled"
                    aria-hidden="true"
                  />
                ) : null}
          ...
          dayCellContent={(arg) => {
            ...
            return (
              <div style={{ lineHeight: 1.1 }}>
                ...
                >
                  <span className="fc-weather-icon" aria-hidden="true">
                    {emoji}
                  </span>
                  <span className="fc-weather-temps">
                    {hi}/{lo}
                  </span>
                </div>
              </div>
